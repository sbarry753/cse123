...
def parse_args():
    ...
    p.add_argument("--piano_residual_loss_weight", type=float, default=0.2)
...
def pretransient_target(
    ...
    with torch.no_grad():
        ...
        teacher_log_mag = guitar_log_mag * teacher_mask + teacher_residual
        target_residual = teacher_log_mag - guitar_log_mag
...
def make_kd_batch(
    ...
    result["teacher_mag"] = pad_to_multiple_2d(teacher_mag.unsqueeze(1))
